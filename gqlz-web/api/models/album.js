...
function createAlbum(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, json_placeholder_1.createResource("/albums", JSON.stringify(input))];
        });
    });
}
...
function updateAlbum(id, input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, json_placeholder_1.updateResource("/albums/" + id, JSON.stringify(input))];
        });
    });
}
...
function deleteAlbum(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, json_placeholder_1.deleteResource("/albums/" + id)];
                case 1:
                    _a.sent();
...
function fetchAlbumPhotos(id, options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, json_placeholder_1.fetchPage("/albums/" + id + "/photos", options)];
        });
    });
}
...
exports.resolvers = {
    Query: {
        albums: function (_, args) {
            return __awaiter(this, void 0, void 0, function () {
                var options;
                return __generator(this, function (_a) {
                    options = args.options;
                    return [2 /*return*/, fetchAlbums(options)];
                });
            });
        },
        album: function (_, args) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    id = args.id;
                    return [2 /*return*/, fetchAlbum(id)];
                });
            });
        },
    },
    Mutation: {
        createAlbum: function (_, args) {
            return __awaiter(this, void 0, void 0, function () {
                var input;
                return __generator(this, function (_a) {
                    input = args.input;
                    return [2 /*return*/, createAlbum(input)];
                });
            });
        },
        updateAlbum: function (_, args) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, id, input;
                return __generator(this, function (_b) {
                    _a = args, id = _a.id, input = _a.input;
                    return [2 /*return*/, updateAlbum(id, input)];
                });
            });
        },
        deleteAlbum: function (_, args) {
            return __awaiter(this, void 0, void 0, function () {
                var id;
                return __generator(this, function (_a) {
                    id = args.id;
                    return [2 /*return*/, deleteAlbum(id)];
                });
            });
        }
    },
    Album: {
        user: function (album) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, user_1.fetchUser(album.userId)];
                });
            });
        },
        photos: function (album, args) {
            return __awaiter(this, void 0, void 0, function () {
                var options;
                return __generator(this, function (_a) {
                    options = args.options;
                    return [2 /*return*/, fetchAlbumPhotos(album.id, options)];
                });
            });
        },
    },
