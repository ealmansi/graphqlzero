...
const Index = withApolloClient(
  function Index (): ReactElement {
    if (process.browser) {
      const googleAnalyticsTrackingCode = process.env.GOOGLE_ANALYTICS_TRACKING_CODE;
      if (
        typeof googleAnalyticsTrackingCode === 'string' &&
        googleAnalyticsTrackingCode.length > 0
      ) {
